const calculate = () => {
    ...
    let kel=cToK(numberTemp);
        ...
        document.getElementById('result2').innerHTML= `Farenheit: ${farh}`;
        ...
        document.getElementById('result2').innerHTML= `Kelvin: ${kel}`;

    }else{

        let cel=kToC(numberTemp);

        let farh=kToF(numberTemp);
